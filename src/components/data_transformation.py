...
class DataTransformation:
    ...
    def get_data_transformer_object(self):
        """
        This function is responsible for creating data transformer pipeline
        """
        try:
    ...
    def initiate_data_transformation(self, train_path: str, test_path: str):
        """
        Reads train and test data, applies preprocessing, and saves the preprocessor as pickle
        """
        try:
